...
This folder contains the history and design evolution of the SAP O2C Graph Explorer.
...
- Visual design patterns (CSS and Canvas logic).
- Troubleshooting steps taken during development.
